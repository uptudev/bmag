...
- Fixed Steammodded bug causing dependency errors with beta versions of Steammodded.

## [v2.0.5] - 2025-09-22

### Changed

- Fixed inconsistent coding style in mod libraries.
- Added a **reset** button to the config menu to reset the current config to default.
...
- Fixed an issue where multiselecting and clicking on UI elements would cause a
crash. 
- Restricted multiselect to work after the mouse has moved, and restrict it to
...
- All old code that falls under GPLv3, including:
  ...
  [Unreleased]: https://github.com/uptudev/bmag/compare/v2.0.6...HEAD
  [v2.0.6]: https://github.com/uptudev/bmag/compare/v2.0.5...v2.0.6
  [v2.0.5]: https://github.com/uptudev/bmag/compare/v2.0.4...v2.0.5
